...
INSERT INTO stb_nodes (`node_id`, `pid`, `cname`, `content`, `keywords`, `ico`, `master`, `permit`, `listnum`, `clevel`, `cord`) VALUES (5, 0, '丰田', '丰田', '丰田', 'uploads/ico/default.png', '', NULL, 0, NULL, NULL);
...
INSERT INTO stb_nodes (`node_id`, `pid`, `cname`, `content`, `keywords`, `ico`, `master`, `permit`, `listnum`, `clevel`, `cord`) VALUES (7, 0, '本田', '本田', '本田', 'uploads/ico/default.png', '', NULL, 0, NULL, NULL);
INSERT INTO stb_nodes (`node_id`, `pid`, `cname`, `content`, `keywords`, `ico`, `master`, `permit`, `listnum`, `clevel`, `cord`) VALUES (8, 0, '日产', '日产', '日产', 'uploads/ico/default.png', 'yinan', NULL, 0, NULL, NULL);
INSERT INTO stb_nodes (`node_id`, `pid`, `cname`, `content`, `keywords`, `ico`, `master`, `permit`, `listnum`, `clevel`, `cord`) VALUES (9, 0, '福特', '福特', '福特', 'uploads/ico/default.png', '', '2', 0, NULL, NULL);
...
INSERT INTO stb_settings (`id`, `title`, `value`, `type`) VALUES (1, 'site_name', '一楠auto- 原车功能微社区-产品bbs', 0);
INSERT INTO stb_settings (`id`, `title`, `value`, `type`) VALUES (2, 'welcome_tip', '欢迎访问  原车功能微社区', 0);
INSERT INTO stb_settings (`id`, `title`, `value`, `type`) VALUES (3, 'short_intro', '新一代简洁社区软件', 0);
...
INSERT INTO stb_settings (`id`, `title`, `value`, `type`) VALUES (8, 'site_description', 'Startbbs 悦车车', 0);
...
INSERT INTO stb_site_stats (`id`, `item`, `value`, `update_time`) VALUES (1, 'last_uid', 1, NULL);
INSERT INTO stb_site_stats (`id`, `item`, `value`, `update_time`) VALUES (2, 'total_users', 1, NULL);
INSERT INTO stb_site_stats (`id`, `item`, `value`, `update_time`) VALUES (3, 'today_topics', 1, 1487851477);
INSERT INTO stb_site_stats (`id`, `item`, `value`, `update_time`) VALUES (4, 'yesterday_topics', 0, 1487851477);
INSERT INTO stb_site_stats (`id`, `item`, `value`, `update_time`) VALUES (5, 'total_topics', 1, NULL);
INSERT INTO stb_site_stats (`id`, `item`, `value`, `update_time`) VALUES (6, 'total_comments', 0, NULL);
...
INSERT INTO stb_topics (`topic_id`, `node_id`, `uid`, `ruid`, `title`, `keywords`, `content`, `addtime`, `updatetime`, `lastreply`, `views`, `comments`, `favorites`, `closecomment`, `is_top`, `is_hidden`, `ord`) VALUES (1, 3, 1, NULL, '大众途观中控拆装指导说明', '大众途观,螺丝刀,示意图,照片,黄色', '用电动扭力可调螺丝刀拆装螺丝：<br />\r\n<br />\r\n先示意一下拆解部位和着力点，这只是示意图，实际拆解时，因为太专注忘记拍照片了，装好后再如实拆一遍又太可惜，所以请见谅：<br />\r\n如图拆机头的关键其实是拆卡片架，这个架的受力点是先是从中间将撬板用力塞进去（白色撬板），这时一定要用大力塞，卡片架的质量弹性很好，会变形容下撬板的，接着如图黄色撬板由卡片架的如图示位置插入以便将此处的卡扣顶开，接着向外用力，听到卡扣脱开的声音后可停止撬板动作，但要保持住，以免卡扣重新扣上。<br />\r\n<br />\r\n<br />\r\n接着如图撬卡片盒的左上角，部位、受力点及操作步骤同上，然后用黄色的撬板在听到卡扣脱开后用力一撬，卡片架随之就撬开了。', 1487851477, 1487851477, 1487851477, 1, 0, 0, NULL, 0, 0, 1487851477);
